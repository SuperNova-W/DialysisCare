...
app = FastAPI(
    ...
    description="OpenAI-based RAG pipeline for peritoneal dialysis knowledge base",
    version="1.0.0",
    lifespan=lifespan
)
...
app.add_middleware(
    ...
    allow_origins=[
        ...
        for origin in os.getenv(
            ...
            "https://dialysiscare-app.web.app,https://dialysiscare-app.firebaseapp.com,"
...
async def quick_questions_endpoint() -> QuickQuestionsResponse:
    ...
    suggested_questions = [
        ...
        "What are the different peritoneal dialysis modalities?",
        "How is peritonitis diagnosed in PD patients?",
        "What treatment options are available for PD?",
        "How is peritoneal dialysis adequacy assessed?",
        "What are the risk factors for PD-related complications?",
        "How does peritoneal dialysis affect kidney function?",
        "What lifestyle changes help manage PD?"
    ]
...
async def root():
    ...
    return {
        ...
        "version": "1.1.0",
        "description": "Fixed-cost single-pass RAG for the baked peritoneal dialysis knowledge base",
        "endpoints": {
